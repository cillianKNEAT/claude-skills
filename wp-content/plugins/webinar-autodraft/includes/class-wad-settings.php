...
class WAD_Settings {
	...
	public function register_settings() {
		...
		// Register settings with minimal options first
	...
	public function render_settings_page() {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				wp_nonce_field( 'wad_settings_nonce', 'wad_settings_nonce' );
				do_settings_sections( 'webinar-autodraft' );
				?>
				<p class="submit">
					<?php submit_button( __( 'Save Settings', 'webinar-autodraft' ), 'primary', 'submit', false ); ?>
				</p>
			</form>
		</div>
		<?php
